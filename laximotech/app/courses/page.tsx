...
export default function CoursesPage() {
    ...
    return (
        <main>
            ...
            {/* PAGE HEADER — hero entrance via CSS */}
            <div className="lx-page-header" style={{ background: '#1F4E79', padding: '60px', textAlign: 'center' }}>
                ...
                <div style={{ maxWidth: '500px', margin: '0 auto', position: 'relative' }}>
                    <input type="text" placeholder="Search courses..." value={search} onChange={(e) => setSearch(e.target.value)}
                        style={{ width: '100%', padding: '14px 20px', borderRadius: '28px', border: 'none', fontSize: '16px', outline: 'none', paddingRight: '50px' }} />
            ...
            <div className="lx-animate" style={{ background: '#fff', borderBottom: '1px solid #eee', padding: '20px 60px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <span style={{ marginLeft: 'auto', fontSize: '14px', color: '#888', alignSelf: 'center' }}>{filtered.length} courses found</span>
            </div>

            {/* COURSES GRID — staggered */}
            <section style={{ padding: '50px 60px', background: '#F0F8FF', minHeight: '60vh' }}>
                {filtered.length === 0 ? (
                    <div className="lx-animate" style={{ textAlign: 'center', padding: '80px', color: '#888' }}>
                            ...
                            <Link href={`/courses/${course.slug}`} style={{ textDecoration: 'none', color: 'inherit' }} key={i}>
                                <div className="lx-course-card">
                                    ...
                                    <div className="lx-course-body">
                                        <div style={{ fontSize: '11px', background: '#E6F1FB', color: '#1F4E79', padding: '3px 10px', borderRadius: '10px', display: 'inline-block', marginBottom: '8px', fontWeight: 600 }}>{course.category}</div>
            ...
            <footer className="lx-footer">
                <div className="lx-footer-bottom" style={{ borderTop: 'none', paddingTop: '30px' }}>
                    ...
                    <div className="lx-payment-badges">
                        <span className="lx-pay-badge">UPI</span><span className="lx-pay-badge">Razorpay</span><span className="lx-pay-badge">Cards</span>
                    </div>
                </div>
            </footer>
        </main>
